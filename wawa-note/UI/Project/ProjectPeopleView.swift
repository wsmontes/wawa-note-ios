...
struct ProjectPeopleView: View {
    ...
    VStack(spacing: 0) {
      if isLoading {
        ...
        VStack(spacing: AppSpacing.md) {
          ...
          Text("People are extracted from analysis and task assignments.").font(.caption)
  ...
  private func loadPeople() async {
    ...
    var nameToSummary:
      [String: (id: UUID, role: String?, taskCount: Int, openTaskCount: Int, mentionCount: Int)] =
        [:]
    ...
    people = nameToSummary.map {
      PersonSummary(
        id: $1.id, name: $0, role: $1.role, taskCount: $1.taskCount,
        openTaskCount: $1.openTaskCount, mentionCount: $1.mentionCount)
    }
