...
extension PermissionPromptView {
    static func calendar(onRequest: @escaping () -> Void) -> PermissionPromptView {
        PermissionPromptView(
            ...
            description: String(localized: "Wawa Note shows your calendar events so you can start recordings with the right meeting context."),
    ...
    static func reminders(onRequest: @escaping () -> Void) -> PermissionPromptView {
        PermissionPromptView(
            ...
            description: String(localized: "Wawa Note creates reminders from your meeting action items so you can track follow-ups."),
    ...
    static func microphone(onRequest: @escaping () -> Void) -> PermissionPromptView {
        PermissionPromptView(
            ...
            description: String(localized: "Wawa Note uses the microphone to record meetings you choose to capture."),
    ...
    static func speechRecognition(onRequest: @escaping () -> Void) -> PermissionPromptView {
        PermissionPromptView(
            ...
            description: String(localized: "Speech recognition is used to turn your recorded meetings into a searchable transcript."),
