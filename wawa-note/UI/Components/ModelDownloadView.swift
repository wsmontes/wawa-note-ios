        ...
        VStack(spacing: 20) {
            ...
            case .modelMissing:
                VStack(spacing: 16) {
                    ...
                    Text("The on-device speech model for **\(locale.identifier)** needs to be downloaded first.")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)

                    Text("This happens automatically when your device is connected to Wi-Fi. Make sure you're online and try again.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
