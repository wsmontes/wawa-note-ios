    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                Text("When enabled, Wawa Note will automatically import new .md files from the watched folder and export changes back.")
            }
            ...
            Section {
                ...
                Text("Import Jinja2 templates from anarlog's enhance, title, and daily-summary prompts. They will be converted to Wawa Note editable prompts.")
            }
