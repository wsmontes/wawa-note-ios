...
final class ProviderAdapter: @unchecked Sendable {
  ...
  static func hint(for provider: any AIProvider) -> ProviderHint {
    ...
    case .anthropic:
      return ProviderHint(
        tactic: .promptedJSON, supportsJSONSchema: false, supportsSystemPrompt: true)
    case .gemini:
      return ProviderHint(
        tactic: .bestEffort, supportsJSONSchema: false, supportsSystemPrompt: true)
    @unknown default:
      return ProviderHint(tactic: .nativeJSON, supportsJSONSchema: true, supportsSystemPrompt: true)
    }
  }
  ...
  static func buildRequest(
    template: AITemplate, variables: [String: String], provider: any AIProvider
  ) -> NormalizedRequest {
