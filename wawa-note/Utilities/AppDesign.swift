  ...
  init(hex: String) {
    ...
    let uiColor = UIColor { traitCollection in
      if traitCollection.userInterfaceStyle == .dark {
        return UIColor(
          red: min(1, r + 0.12), green: min(1, g + 0.12), blue: min(1, b + 0.12), alpha: 1)
      }
...
enum AppCopy {
  ...
  static let noTranscript =
    "Your transcript will appear here.\nTap Transcribe Meeting to get started."
  static let noActionItems =
    "Action items from your recording will appear here once you generate a summary."
  ...
  static let privacyLocalFirst =
    "Your audio stays on this iPhone. Nothing leaves your device unless you connect an AI service for summaries."
  ...
  static let connectAIDescription =
  ...
  // MARK: - Error Messages
  static let errorAudioNotFound =
    "The audio file couldn't be found. It may have been moved or deleted. Try recording again."
  static let errorTranscriptionFailed =
    "Transcription didn't finish. Your recording is safe. You can try again."
  static let errorAnalysisFailed =
    "Summary generation didn't finish. Your transcript is safe. Check your AI service connection or try again."
  static let errorNoAIService =
    "No AI service connected. Go to Settings to connect one, then try again."
  static let errorMicrophoneDenied =
    "Microphone access is off. Turn it on in Settings > Privacy > Microphone, then come back."
  static let errorPlaybackFailed =
    "Couldn't play the recording. The audio file may be missing or damaged."
}
...
extension View {
  func projectCard(padding: CGFloat = AppSpacing.md, cornerRadius: CGFloat = AppRadius.lg)
    -> some View
  {
