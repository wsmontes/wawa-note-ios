...
enum AnarlogParticipantBridge {
    private static let logger = Logger(subsystem: "com.wawa.note", category: "AnarlogParticipantBridge")
    ...
    static func readParticipants(
        ...
        let annotationService = AnnotationService(context: context)
        let annotations = (try? annotationService.annotations(for: itemID, source: "anarlog_import")) ?? []
