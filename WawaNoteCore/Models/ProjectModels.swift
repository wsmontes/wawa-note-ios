...
public final class TaskItem {
  ...
  public var sourceSegmentIDList: [String] {
  ...
  public var createdBy: FieldOrigin? {
  ...
  public var fieldProvenance: FieldProvenance {
...
public final class GraphEdge {
  ...
  public var provenanceSegmentIDList: [String] {
...
public final class ProjectFrame {
  ...
  public var isRoot: Bool { parentFrameID == nil }
  ...
  public var filterItemTypes: [String] {
...
public final class AgentSuggestion {
  ...
  public var computedPriority: Double {
...
public final class ProjectDerivedItem {
  ...
  public var type: ProjectDerivedType {
  ...
  public var status: ProjectDerivedStatus? {
...
public struct SignalBody: Codable, Sendable {
  ...
  public init(
    signalType: String, description: String, suggestedAction: String? = nil,
    relatedItemIDs: [UUID]? = nil, impactScore: Double? = nil, urgencyScore: Double? = nil
  ) {
...
public struct SynthesisSection: Codable, Sendable {
  ...
  public init(
    id: String = "", title: String = "", renderType: String = "markdown", content: String = "",
    order: Int = 0
  ) {
...
public struct SynthesisMetric: Codable, Sendable {
  ...
  public init(
    id: String = "", label: String = "", value: Double = 0, format: String = "number",
    status: String = "neutral", icon: String? = nil
  ) {
