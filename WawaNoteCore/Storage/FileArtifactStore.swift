...
public final class FileArtifactStore: @unchecked Sendable {
  ...
  public func storeImportedFile(sourceURL: URL, itemId: UUID, originalFileName: String) throws
    -> URL
  {
...
public struct RecordingSegment: Codable, Identifiable, Sendable {
  ...
  public init(
    id: UUID = UUID(), index: Int, fileName: String, startedAt: Date, endedAt: Date? = nil,
    inputPortName: String, inputPortType: String, routeChangeReason: String,
    sampleRate: Double? = nil, fileSize: Int64? = nil
  ) {
    self.id = id
    self.index = index
...
public struct RecordingManifest: Codable, Sendable {
  ...
  public init(
    recordingId: UUID, title: String, startedAt: Date, endedAt: Date? = nil,
